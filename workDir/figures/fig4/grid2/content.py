...
images = [
    manage_images.load_image(scene='bookshelf', method=method_name) for method_name in method_names
]
colors = [
    [232, 181, 88],
    [5, 142, 78],
...
errors = [
    manage_images.get_error(scene='bookshelf', method=method) for method in method_names
]
