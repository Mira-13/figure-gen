...
first = manage_images.bookshelf120_patht
third = manage_images.bookshelf120_upscmc
fourth = manage_images.bookshelf120_radia
fifth = manage_images.bookshelf120_ofull

# get an image for the resolution 
a = manage_images.bookshelf_crop(1, reference)
...
def crop_1(img):
    ...
    zoomedSRGBCrop = zoom_and_lin_to_srgb(manage_images.bookshelf_crop(1, img))
    return zoomedSRGBCrop

def crop_2(img):
    zoomedSRGBCrop = zoom_and_lin_to_srgb(manage_images.bookshelf_crop(2, img))
    return zoomedSRGBCrop
