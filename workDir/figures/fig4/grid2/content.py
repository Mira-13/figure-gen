...
a = manage_images.bookshelfCrop1(reference)
...
def crop_1(img):
    global cropAndZoom
    zoomedCrop = cropAndZoom(img, manage_images.bookshelfCrop1)
    return util.image.lin_to_srgb(zoomedCrop)

def crop_2(img):
    zoomedCrop = cropAndZoom(img, manage_images.bookshelfCrop2)
    return util.image.lin_to_srgb(zoomedCrop)
