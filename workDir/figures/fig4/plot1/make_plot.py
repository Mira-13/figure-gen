...
def plot_errors(scene, integrators=["path","pgrad7","pgfull7","upsmcmc"], metric='MRSE'):
    ...
    # mark sth
    ax.axvline(x=28.32, color=scaleRGB(94, 163, 188), linewidth=0.6, linestyle=(0, (4, 6)))
    ax.axvline(x=28.78, color=scaleRGB(181, 63, 106), linewidth=0.6, linestyle=(-5, (4, 6)))

    plt.savefig("gen_plot.pdf", pad_inches=0.0)
    # plt.savefig("gen_plot.pgf", pad_inches=0.0)

plot_errors("bookshelf", metric="MRSE*")
