...
images = [
    manage_images.load_image(scene='living-room', method=method_name) for method_name in method_names
]
colors = [
    [232, 181, 88],
    [5, 142, 78],
...
errors = [
    manage_images.get_error(scene='living-room', method=method) for method in method_names
]
...
captions.append(r"\vspace*{5.0pt}\textsf{Reference}" + "\n" + r"\textsf{\emph{relMSE} ("+ str(manage_images.get_time_sec(scene='living-room')) +"s)}")
