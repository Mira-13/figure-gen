...
first = manage_images.livroom120_patht
second = manage_images.livroom120_bdpt
fourth = manage_images.livroom120_radia
third = manage_images.livroom120_upscmc
fifth = manage_images.livroom120_ofull

# get an image for the resolution 
a = manage_images.livingRoomInset1(reference)
...
def crop_1(img):
    global cropAndZoom
    zoomedCrop = cropAndZoom(img, manage_images.livingRoomInset1)
    return util.image.lin_to_srgb(zoomedCrop)

def crop_2(img):
    zoomedCrop = cropAndZoom(img, manage_images.livingRoomInset2)
    return util.image.lin_to_srgb(zoomedCrop)
