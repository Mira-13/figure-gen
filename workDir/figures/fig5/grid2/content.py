...
first = manage_images.gloskitch90_patht
third = manage_images.gloskitch90_upscmc
fourth = manage_images.gloskitch90_radia
fifth = manage_images.gloskitch90_ofull

# get an image for the resolution 
a = manage_images.gkitchen_crop(1, reference)
...
def crop_1(img):
    ...
    zoomedSRGBCrop = zoom_and_lin_to_srgb(manage_images.gkitchen_crop(1, img))
    return zoomedSRGBCrop

def crop_2(img):
    zoomedSRGBCrop = zoom_and_lin_to_srgb(manage_images.gkitchen_crop(2, img))
    return zoomedSRGBCrop
